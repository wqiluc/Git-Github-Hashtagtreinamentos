...
<p align="center">
Este repositório tem como objetivo documentar minha jornada de aprendizado em Git e GitHub, desenvolvida por meio da Hashtag Treinamentos.
Aqui estão reunidos conceitos fundamentais, comandos essenciais e boas práticas, além de anotações e exemplos práticos que servem como um guia de referência para quem deseja compreender e se aprofundar no uso dessas tecnologias. ✅ 
</p>
...
│
├── modulo-2/
│   ├── 2.pdf <img src="https://img.shields.io/badge/PDF-EA4335?style=for-the-badge&logo=adobeacrobatreader&logoColor=white" height="15"/>
│   └── 2-9.txt📄
│
├── modulo-3/
│   └── 10-14.txt📄
...
git --version (ou v) # Verifica a versão do git na máquina do usuário 💻
